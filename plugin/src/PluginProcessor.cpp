...
void AudioPluginAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock) {
    if (sampleRate > 0) {
        sharedData.parameters->prepareToPlay(static_cast<Decimal>(sampleRate), static_cast<Eigen::Index>(samplesPerBlock));
        audioProcessor.prepareToPlay(static_cast<Decimal>(sampleRate), static_cast<Eigen::Index>(samplesPerBlock));
    }
}
